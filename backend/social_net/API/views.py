...
def AuthorsView(request):
    """
    API endpoint for getting all authors on the server 2.0.
...
def PostsRetrieveView(request, author_id, post_id):
    ...
    ---
    get:
        description: Get the public post with specified id.
        responses:
            200:
    ...
    delete:
        description: Delete the post with specified id.
        responses:
            200:
                description: Successful operation
        security:
    ...
    put:
        description: Create a post with specified id.
        responses:
            200:
                description: Successful operation
        security:
